    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="margin-top: 1% !important;">
                       <a href="../index.php" class="logo me-auto me-lg-0"><img src="logo.png" style="height: 80px;" alt="" class="img-fluid"></a>
                    </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Life Care</h5>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider_3.png" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Welcome to Life Care Hospital</h5>
...
<!--             <ul>
    ...
    <section id="gallery" class="gallery">
      <div class="container-fluid">
        ...
        <div class="section-title">
          <h2>Gallery</h2>
          <p>Some photos from our Hospital</p>
        </div>

        <div class="row g-0">

          <div class="col-lg-3 col-md-4">
            <div class="galjpglery-item">
              <a href="doctor.jpg" class="gallery-lightbox">
                <img src="doctors.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="patient.jpg" class="gallery-lightbox">
                <img src="patients.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
 ...
 <footer id="footer">
    <div class="container">
      ...
      <p>We care about your Life </p>
      <div class="copyright">
        &copy; Copyright <strong><span>Life Care - Hospital</span></strong>. All Rights Reserved
      </div></div></footer>
